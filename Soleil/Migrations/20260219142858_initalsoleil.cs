...
{
    /// <inheritdoc />
    public partial class initalsoleil : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Games_QuestionnaireFields_FieldId",
                        column: x => x.FieldId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Questions_QuestionnaireFields_FieldId",
                        column: x => x.FieldId,
                        principalTable: "QuestionnaireFields",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SocialPercentage = table.Column<double>(type: "float", nullable: false),
                    CommunicationPercentage = table.Column<double>(type: "float", nullable: false),
                    SkillsPercentage = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EyeScanTests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EyeScanTests_Children_ChildId",
                        column: x => x.ChildId,
                        principalTable: "Children",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GameSessions_Children_ChildId",
                        column: x => x.ChildId,
                        principalTable: "Children",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuestionnaireResults_Children_ChildId",
                        column: x => x.ChildId,
                        principalTable: "Children",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuestionnaireResults_QuestionnaireFields_FieldId",
                        column: x => x.FieldId,
                        principalTable: "QuestionnaireFields",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionnaireResults_ChildId",
                table: "QuestionnaireResults",
                column: "ChildId");

            migrationBuilder.CreateIndex(
                name: "IX_QuestionnaireResults_FieldId",
                table: "QuestionnaireResults",
                column: "FieldId");
